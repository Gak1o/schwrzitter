...
## ListMyDeferredItems
You can execute the `ListMyDeferredItems` Query using the following Query injector, which is defined in [dataconnect-generated/angular/index.d.ts](./index.d.ts):

```javascript
injectListMyDeferredItems(options?: ListMyDeferredItemsOptions, injector?: Injector): CreateDataConnectQueryResult<ListMyDeferredItemsData, undefined>;
```

### Variables
The `ListMyDeferredItems` Query has no variables.
### Return Type
Recall that calling the `ListMyDeferredItems` Query injector returns a `CreateDataConnectQueryResult` object. This object holds the state of your Query, including whether the Query is loading, has completed, or has succeeded/failed, and any data returned by the Query, among other things.
...
To access the data returned by a Query, use the `CreateDataConnectQueryResult.data()` function. The data for the `ListMyDeferredItems` Query is of type `ListMyDeferredItemsData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `ListMyDeferredItems`'s Query injector

```javascript
... // other imports
import { connectorConfig } from '@dataconnect/generated';
import { injectListMyDeferredItems, ListMyDeferredItemsOptions } from '@dataconnect/generated/angular'
...
export class MyComponent {
  ...
  query = injectListMyDeferredItems();

  // You can also pass in an options function (not object) of type `ListMyDeferredItemsOptions` to the Query injector function.
  options: ListMyDeferredItemsOptions = () => {
    return {
      staleTime: 5 * 1000
    };
  };
  query = injectListMyDeferredItems(this.options);
}
```

## GetContext
You can execute the `GetContext` Query using the following Query injector, which is defined in [dataconnect-generated/angular/index.d.ts](./index.d.ts):

```javascript
injectGetContext(options?: GetContextOptions, injector?: Injector): CreateDataConnectQueryResult<GetContextData, undefined>;
```

### Variables
The `GetContext` Query has no variables.
### Return Type
Recall that calling the `GetContext` Query injector returns a `CreateDataConnectQueryResult` object. This object holds the state of your Query, including whether the Query is loading, has completed, or has succeeded/failed, and any data returned by the Query, among other things.

To check the status of a Query, use the `CreateDataConnectQueryResult.status()` function. You can also check for pending / success / error status using the `CreateDataConnectQueryResult.isPending()`, `CreateDataConnectQueryResult.isSuccess()`, and `CreateDataConnectQueryResult.isError()` functions.

To access the data returned by a Query, use the `CreateDataConnectQueryResult.data()` function. The data for the `GetContext` Query is of type `GetContextData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `GetContext`'s Query injector

```javascript
... // other imports
import { connectorConfig } from '@dataconnect/generated';
import { injectGetContext, GetContextOptions } from '@dataconnect/generated/angular'
import { DataConnect } from '@angular/fire/data-connect';
import { initializeApp } from '@angular/fire/app';
...
export class MyComponent {
  // Since the execution of the query is eager, you don't have to call `execute` to "execute" the Query.
  // Call the Query injector function to get a `CreateDataConnectQueryResult` object which holds the state of your Query.
  query = injectGetContext();

  // You can also pass in an options function (not object) of type `GetContextOptions` to the Query injector function.
  options: GetContextOptions = () => {
    return {
      staleTime: 5 * 1000
    };
  };
  query = injectGetContext(this.options);
}
```

## GetMyProfile
You can execute the `GetMyProfile` Query using the following Query injector, which is defined in [dataconnect-generated/angular/index.d.ts](./index.d.ts):

```javascript
injectGetMyProfile(options?: GetMyProfileOptions, injector?: Injector): CreateDataConnectQueryResult<GetMyProfileData, undefined>;
```

### Variables
The `GetMyProfile` Query has no variables.
### Return Type
Recall that calling the `GetMyProfile` Query injector returns a `CreateDataConnectQueryResult` object. This object holds the state of your Query, including whether the Query is loading, has completed, or has succeeded/failed, and any data returned by the Query, among other things.

To check the status of a Query, use the `CreateDataConnectQueryResult.status()` function. You can also check for pending / success / error status using the `CreateDataConnectQueryResult.isPending()`, `CreateDataConnectQueryResult.isSuccess()`, and `CreateDataConnectQueryResult.isError()` functions.

To access the data returned by a Query, use the `CreateDataConnectQueryResult.data()` function. The data for the `GetMyProfile` Query is of type `GetMyProfileData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `GetMyProfile`'s Query injector

```javascript
... // other imports
import { connectorConfig } from '@dataconnect/generated';
import { injectGetMyProfile, GetMyProfileOptions } from '@dataconnect/generated/angular'
import { DataConnect } from '@angular/fire/data-connect';
import { initializeApp } from '@angular/fire/app';
...
export class MyComponent {
  // Since the execution of the query is eager, you don't have to call `execute` to "execute" the Query.
  // Call the Query injector function to get a `CreateDataConnectQueryResult` object which holds the state of your Query.
  query = injectGetMyProfile();

  // You can also pass in an options function (not object) of type `GetMyProfileOptions` to the Query injector function.
  options: GetMyProfileOptions = () => {
    return {
      staleTime: 5 * 1000
    };
  };
  query = injectGetMyProfile(this.options);
}
```
...
## CreateDeferredItem
You can execute the `CreateDeferredItem` Mutation using the `CreateDataConnectMutationResult` object returned by the following Mutation injector (which is defined in [dataconnect-generated/angular/index.d.ts](./index.d.ts)):
```javascript
injectCreateDeferredItem(options?: CreateDeferredItemOptions, injector?: Injector): CreateDataConnectMutationResult<CreateDeferredItemData, CreateDeferredItemVariables, CreateDeferredItemVariables>;
```
...
```
### Return Type
Recall that calling the `CreateDeferredItem` Mutation injector returns a `CreateDataConnectMutationResult` object. This object holds the state of your Mutation, including whether the Mutation is loading, has completed, or has succeeded/failed, among other things.
...
To access the data returned by a Mutation, use the `CreateDataConnectMutationResult.data()` function. The data for the `CreateDeferredItem` Mutation is of type `CreateDeferredItemData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `CreateDeferredItem`'s Mutation injector

```javascript
... // other imports
import { connectorConfig, CreateDeferredItemVariables } from '@dataconnect/generated';
import { injectCreateDeferredItem, CreateDeferredItemOptions } from '@dataconnect/generated/angular'
import { DataConnect } from '@angular/fire/data-connect';
import { initializeApp } from '@angular/fire/app';
...
export class MyComponent {
  ...
  mutation = injectCreateDeferredItem();

  // You can also pass in a `CreateDeferredItemOptions` function (not object) to the Mutation injector function.
  options: CreateDeferredItemOptions = () => {
    return {
      onSuccess: () => { console.log('Mutation succeeded!'); }
    };
  };
  mutation = injectCreateDeferredItem(this.options);
  ...
  executeMutation() {
    ...
    this.mutation.mutate(createDeferredItemVars);
    // Variables can be defined inline as well.
    this.mutation.mutate({ description: ..., notes: ..., reminderDateTime: ..., });
    ...
    this.mutation.mutateAsync(createDeferredItemVars);

    // You can also pass in a `CreateDeferredItemOptions` object (not function) to `CreateDataConnectMutationResult.mutate()`.
    this.mutation.mutate(createDeferredItemVars, this.options());
  }
}
```
